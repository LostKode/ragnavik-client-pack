...
| Version  | Changes                                                                                              |
|----------|------------------------------------------------------------------------------------------------------|
| 1.1.35  | Depend on Ragnavik Shared for client-and-server gameplay mods. Keep client-only interface and convenience mods here, and stop installing server-only Network and Server Bridge code on players. |
