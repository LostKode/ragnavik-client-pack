...
| 1.1.17  | Replace CustomMainMenu with Ragnavik UI 1.1.0. Add the separate website backed Ragnavik changelog while preserving Valheim's native changelog. Keep CurrencyPocket as a direct client package dependency because Ragnavik UI no longer adjusts its layout. |
